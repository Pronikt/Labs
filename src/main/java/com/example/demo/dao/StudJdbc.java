...
public class StudJdbc {
    ...
    public Student getStud(int id) {
        return jdbcTemplate.queryForObject("SELECT * FROM student WHERE id_s = ?", this::mapStud, id);
    }
    ...
    public int insStud(int id, String surname, String name, String second_name, int grid){
        return jdbcTemplate.update("INSERT into student(id_s, surname, name, second_name, study_group_id) values (?,?,?,?,?)", id,surname ,name, second_name, grid);
    }
